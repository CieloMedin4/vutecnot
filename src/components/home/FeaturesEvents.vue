    ...
    <v-row align="center" justify="center" class>
      <v-col cols="12" md="12" lg="12" sm="12" class="mb-0">
        <p class="google-font mb-0 mt-0" style="font-weight: 350;font-size:180%">
          <b>
            INFORMACION DE 
            <span style="color: #1a73e8;">EVENTO</span>
            SOBRE
            <span style="color: #1a73e8;">ASISTENTES DE VOZ</span>
          </b>
        </p>
        <p
          class="google-font mt-0 mb-0"
          style="font-size:95%"
        >La implementación de esta tecnología dentro de los hogares ha ido en aumento durante los últimos años.</p>
      </v-col>
