<template>
  <div class="text-center">
    <v-dialog v-model="dialog" width="500">
      ...
      <v-card>
        <v-card-title>Permitenos enviar notificaciones push</v-card-title>

        <v-card-text>
          <p>Nunca le enviamos spam enviando notificaciones push innecesarias.</p>
          <p>
