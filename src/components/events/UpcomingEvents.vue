  ...
  <v-container fluid>
    ...
    >
      <v-col cols="12" md="12" lg="12" sm="12" class>
        <p class="google-font mb-0" style="font-size:150%;color: #1a73e8;">Comentanos</p>
        <p
          class="google-font mt-0"
          style="font-size:95%"
        >Acercate con nosotros, ya que para nosotros esz importante que estes agusto en este espacio.</p>
        ...
        <v-row v-if="notFoundUpcomingEventFlag" class="pa-2">
          ...
          >
            <p class="google-font px-2 mb-0" style="font-size:140%">
              ...
              <br />Por el moemto no hay Comentarios, se el primero!
            </p>
          </v-col>
        </v-row>
      </v-col>
